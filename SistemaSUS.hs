...
* Observacoes: Todas as funcoes auxiliares para as funcoes descritas nas questoes estao no final do codigo
                (pesquise FUNCOES AUXILIARES para encontrar) 

              : Todas as questoes tem seus Topicos comentados para um melhor processo de avaliacao,  no formato
                 -- QUESTAO A
                 -- QUESTAO B
                 -- QUESTAO C 
                 -- ...

              : Para nao alterar os parametros das funcoes ja definidas no PDF da Lista, utilizei o que seria o parametro DataHoje como uma constante
              no escopo Global do Software (estou ciente na possibilidade de colocar como parametro, porem nao consegui entrar em contato a tempo para
                saber se isso afetaria a nota)
...
getEstado (_,_,_,_,_,_,municipio,_,_) = municipio
